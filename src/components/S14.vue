...
export default {
  methods: {
    html() {
      var a = document.getElementById("s14").innerHTML;
    ...
    css() {
      var b = document.getElementsByTagName("style")[14].innerHTML;
...
@supports (-webkit-background-clip: text) {
  p {
    color: transparent;
    background-image: linear-gradient(10deg, deeppink, #1000a5);
